...
public class Home extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Send manual movement commands to RPi
        upBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"forward\"}");
        });

        downBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"backward\"}");
        });

        leftBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"forward_left\"}");
        });

        rightBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"forward_right\"}");
        });

        bleftBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"backward_left\"}");
        });

        brightBtn.setOnClickListener(v -> {
          Home.printMessage("{\"cat\":\"control\",\"value\":\"backward_right\"}");
        });
